...
<div id="mailchimp">
  <div class="row">
    <div class="col-md-12">
      <h2>Register for veraPDF news</h2>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
      ...
      <div class="mc-field-group form-group">
          <strong class="col-sm-2 text-right">Email Format </strong>
          <div class="col-sm-1">
            <input type="radio" value="html" name="EMAILTYPE" id="mce-EMAILTYPE-0" checked><label for="mce-EMAILTYPE-1"> HTML</label>
          </div>
          <div class="col-sm-1">
        ...
        <div class="clear text-center"><input type="submit" value="Register" name="subscribe" id="mc-embedded-subscribe" class="btn btn-lg btn-danger"></div>
    </div>
  </form>
</div>
